 ...
 */
export function ImageCarouselComponent(properties, children) {
    const images = [];
    ...
    if (images.length === 0) {
        return h("div", { class: "hidden" }, "Carousel directive must contain images.");
    }
    ...
    // --- Controls ---
    const prevBtn = h("button", { class: "carousel-control-prev", type: "button", "data-bs-target": uniqueId, "data-bs-slide": "prev" }, [
        h("span", { class: "carousel-control-prev-icon", "aria-hidden": "true" }),
        h("span", { class: "visually-hidden" }, "Previous")
    ]);

    const nextBtn = h("button", { class: "carousel-control-next", type: "button", "data-bs-target": uniqueId, "data-bs-slide": "next" }, [
        h("span", { class: "carousel-control-next-icon", "aria-hidden": "true" }),
        h("span", { class: "visually-hidden" }, "Next")
    ]);

    // --- Indicators ---
    const indicators = h("div", { class: "carousel-indicators" }, 
        images.map((_, index) => h("button", {
            type: "button",
    ...
    // Root Container
    return h("div", { class: "carousel slide", id: uniqueId, "data-bs-ride": "carousel" }, [
        indicators,
        inner,
        prevBtn,
        nextBtn
